      ...
      >
        ...
        <view class="user">
          <view class="avatar">
            ...
            <u-upload ref="avatarPreviewRef" :fileList="avatar" name="avatar" width="200rpx" :preview-full-image="false"
                      height="200rpx" :maxCount="1" @afterRead="Read"
                      @delete="Del"></u-upload>
            <!--            </u-form-item>-->
            <!-- #endif -->
          ...
          <view class="nickname">{{ business.nickname||business.mobile }}</view>
        </view>
        <!-- 表单 -->
        <view class="profile">
          <!-- 手机号 -->
          ...
          >
            <u-cell :border="false" :value="business.gender_text||'请选择性别'"></u-cell>
          ...
          <pick-regions :defaultRegion="business.region_code" @getRegion="handleGetRegion">
            <u-form-item
                ...
                ref="region_text"
            >
              <view @getRegion.capture="handleGetRegion">
                <u-cell :border="false" :value="business.region_text||'请选择地区'"></u-cell>
              </view>
              <u-icon slot="right" name="arrow-right"></u-icon>
            </u-form-item>
          </pick-regions>
...
export default {
  ...
  onShow() {
    ...
    this.$set(this.business, "region_code", this.business.district || this.business.city || this.business.province)
    this.business.region_text = [this.business.province_text, this.business.city_text, this.business.district_text].filter(e => e != null && e.length !== 0).join("/")
  },
  data() {
    return {
      ShowGender: false,
  ...
  methods: {
    ...
    handleGetRegion(region) {
      ...
      this.$set(this.business, "region_code", region[2]['code'])
    },
    //删除图片
    Del() {
      this.avatar = []
